...
temp_data.query("18 > hour > 12")
temp_data['Date'].dt.hour > 12 & temp_data['Date'].dt.hour < 18
...
def over_time(temp_data):
    ...
    ax[1].tick_params(axis='x', which='major', labelsize=15, direction='out', length=8, width=1, pad=15)
